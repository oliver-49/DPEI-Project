...
import 'package:dpei_project/presentation/screens/account_service/locationui/location_acssess_view.dart';
        ...
        children: [
          ...
          buttonItem(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const LocationAcssess(),
                ),
              );
            },
          ),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Image.asset('assets/images/60.png', width: screenWidth * 0.06),
