    ...
    return    Column(
      children: 
        ...
        Column(
              ...
              ...List.generate(
                ViewAll?
                (providers.length/2).toInt():1,(i)=> SizedBox(
                ...
                child: 
                  ...
                  onTap: () {
                        print("-------\n\n${provider!.uid}");
                        print("-------\n\n${providers[(i+1)*2-2].uid}");
                     Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>  ProviderProfile(
                      // providers:providers,
                      customer_data: provider,
                      provider_data: providers[(i+1)*2-2],
                      imagePath:"${list[(i+1)*2-2]['img']!}")),
                  );
                  },
                        child: Container(
                          ...
                          child: Center(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(providers[(i+1)*2-2].service,
                                style: TextStyle(
                                  color: AppColors.textColor,
                                  fontSize: 16
                                ),
                  ...
                  onTap: () {
                    ...
                    MaterialPageRoute(builder: (context) =>  ProviderProfile(
                      customer_data: provider,
                      provider_data: providers[(i+1)*2-1],
                      imagePath:"${list[(i+1)*2-1]['img']!}")),
                  );
                  },
                        child: Container(
                        // height: Dimensions(context).height10*10,
                          ...
                          child: Center(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(providers[(i+1)*2-1].service,
                                style: TextStyle(
                                  color: AppColors.textColor,
                                  fontSize: 16
                                ),
