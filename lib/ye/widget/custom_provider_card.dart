      ...
      children: List.generate(Data.length, (i) {
        ...
        return Column(
          children: [
            ...
            ...List.generate(
              ViewAll ? (providers.length / 2).toInt() : 1,
              (i) => SizedBox(
                                  ...
                                  children: [
                                    Center(
                                      child: Image.asset(
                                        ...
                                        // width: double.infinity,
                                        height:
                                            Dimensions(context).height10 * 12,
