...
<<<<<<< Updated upstream:lib/booking_services/view/date.dart
    ...
    return BlocListener<BookingCubit, BookingState>(
      listener: (context, state) {
        if (state is TimeSuccessState) {
          Get.snackbar(
            lang.success,
            lang.theDateHasBeenAddedSuccessfully,
            backgroundColor: Colors.green,
          );
          Get.to(Reviewsummary());
        }
                            ...
                            children: [
                              GestureDetector(
                                ...
                                child: const Icon(
                                  Icons.arrow_back,
                                  color: Color(0xff2B54A4),
>>>>>>> Stashed changes:lib/gitHub/booking_services/view/date.dart
                                ),
                              ),
